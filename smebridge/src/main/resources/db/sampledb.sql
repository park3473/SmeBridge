...
CREATE TABLE `tbl_board` (
  ...
  `file` varchar(45) DEFAULT NULL COMMENT '파일 여부',
  `file_cnt` int(11) DEFAULT NULL COMMENT '파일 갯수',
  PRIMARY KEY (`idx`)
...
CREATE TABLE `tbl_board_data` (
  ...
  `type` varchar(300) DEFAULT NULL COMMENT '게시글 타입 ( 비밀글 , 그냥글 )',
  `title` varchar(300) DEFAULT NULL COMMENT '게시글 제목',
  `content` varchar(300) DEFAULT NULL COMMENT '게시글 내용\n',
  `member_id` varchar(300) DEFAULT NULL COMMENT '작성자 아이디\n',
  `name` varchar(300) DEFAULT NULL COMMENT '작성자 이름',
  `create_tm` datetime DEFAULT NULL COMMENT '게시글 작성 시간\n',
  `update_tm` datetime DEFAULT NULL COMMENT '게시글 수정 시간\n',
  `image` varchar(300) DEFAULT NULL COMMENT '게시판 이미지 (썸네일 용)\n',
  `file` varchar(45) DEFAULT NULL COMMENT '파일 유무',
  PRIMARY KEY (`idx`)
...
CREATE TABLE `tbl_board_reply` (
  ...
  PRIMARY KEY (`idx`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='게시글 댓글 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_board_reply` VALUES (1,1,1,'ddd','test','test',NULL,NULL);
...
CREATE TABLE `tbl_config` (
  ...
  `memo` varchar(45) DEFAULT NULL COMMENT '설정 메모',
  `config` varchar(45) DEFAULT NULL COMMENT '설정 여부',
  PRIMARY KEY (`idx`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='서버 설정 테이블\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_config` VALUES (1,'PARKING','홈페이지 Parking 여부','2022-11-10 11:16:19','2022-11-10 11:16:30','TRUE OR FALSE','FALSE');
...
CREATE TABLE `tbl_file` (
  ...
  `type` varchar(45) DEFAULT NULL COMMENT '파일 타입\n',
...
CREATE TABLE `tbl_member` (
  ...
  `member_id` varchar(45) DEFAULT NULL COMMENT '회원 아이디\n',
  `password` varchar(300) DEFAULT NULL COMMENT '회원 비밀번호',
  `name` varchar(45) DEFAULT NULL COMMENT '회원 이름\n',
  ...
  PRIMARY KEY (`idx`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='유저 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_member` VALUES (1,1,1,'test','03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4','pkh','34733452','12','12','2022-11-13 17:09:22','2022-11-13 17:09:29');
...
-- Dump completed on 2022-12-07 11:07:30
