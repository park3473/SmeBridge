...
function UpdateModalOpen(idx , e){
	...
	$('[name=insert_menu_title]').val($(e).attr('menu_title'));
...
function MenuInsertData(){
	...
	var title = $('[name=insert_menu_title]').val();
	...
	console.log(type + "," + depth + "," + title + "," + upper_menu_idx + "," + seq + "," + name + "," + link);
