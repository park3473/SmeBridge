...
public class CkeditorController {
	...
	@RequestMapping(value = "/ckeditor/file_upload.do", method = RequestMethod.POST ,produces = "application/json; charset=utf8")
	@ResponseBody
	public String communityImageUpload(HttpServletRequest request, HttpServletResponse response, @RequestParam MultipartFile upload ) 
	{
	    ...
	    return "{\"uploaded\":1, \"url\":\"" + "http://115.91.131.154:8040/resources"+request.getContextPath()+"/upload/notices/"+fileName + "\"}";
	}
