package egovframework.smebridge.user.board.controller;
...
import egovframework.smebridge.user.board.model.UserBoardVo;
import egovframework.smebridge.user.board.service.UserBoardService;
