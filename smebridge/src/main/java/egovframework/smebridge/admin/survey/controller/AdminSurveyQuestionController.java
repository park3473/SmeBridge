...
public class AdminSurveyQuestionController {
	...
	@RequestMapping(value="/admin/survey/question/update.do" , method = RequestMethod.POST)
	public void AdminSurveyQuestionUpdate(@ModelAttribute("AdminSurveyQuestionVo")AdminSurveyQuestionVo AdminSurveyQuestionVo , HttpServletRequest request , HttpServletResponse response) {
		
		adminSurveyQuestionService.setSurveyQuestionData(AdminSurveyQuestionVo , "update");
		
	}
	
	@RequestMapping(value="/admin/survey/question/delete.do" , method = RequestMethod.POST)
	public void AdminSurveyQuestionDelete(@ModelAttribute("AdminSurveyQuestionVo")AdminSurveyQuestionVo AdminSurveyQuestionVo , HttpServletRequest request , HttpServletResponse response) {
		
		adminSurveyQuestionService.setSurveyQuestionData(AdminSurveyQuestionVo , "delete");
